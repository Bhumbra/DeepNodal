...
creation_dict = {'identity': tf.identity,
                 ...
                 'sce': tf_sum_cross_entropy,
                 'nllc': tf_mean_sparse_nllc,
                 'nce': tf.nn.nce_loss,
                 'clip_gnorm': tf.clip_by_global_norm,
                 'clip_norm': tf.clip_by_norm,
                 'clip_val': tf.clip_by_value,
                 'onehot': tf.one_hot,
